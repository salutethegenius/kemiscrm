        ...
        <div ref={ref}>
          ...
          <div className={`flex flex-wrap gap-3 ${isVisible ? "animate-fade-up delay-200" : "opacity-0"}`}>
            {techStack.map((tech, i) => (
              <div
                key={i}
                className="group relative overflow-hidden rounded-xl border border-[var(--landing-border)] bg-[var(--landing-card)] px-5 py-3 transition-all duration-300 hover:border-accent/40 hover:shadow-md"
              >
