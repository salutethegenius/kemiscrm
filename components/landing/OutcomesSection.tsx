          ...
          <div className={`${isVisible ? "animate-slide-in-right delay-200" : "opacity-0"}`}>
            <div className="space-y-3">
              {outcomes.map((item, i) => (
                <div
                  key={i}
                  className="flex items-center gap-4 rounded-xl border border-[var(--landing-border)]/50 bg-[var(--landing-card)]/50 px-5 py-4 backdrop-blur-sm transition-all duration-300 hover:border-accent/30 hover:bg-[var(--landing-card)] hover:shadow-sm"
                >
