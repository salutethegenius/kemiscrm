...
const tiers = [
  {
    ...
    footer: "For Bahamian businesses that want discipline and visibility without monthly SaaS bills.",
    highlighted: false,
  },
  {
    ...
    <section id="pricing" className="relative py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div ref={ref}>
                ...
                <a
                  ...
                  className={`mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl px-6 py-3 text-sm font-semibold transition-all duration-300 ${
                    tier.highlighted
                      ...
                      : "border border-border bg-secondary text-foreground hover:border-accent/40 hover:bg-accent/5"
                  }`}
                >
                  Get Started
          ...
          {addOns.length > 0 && (
            <div
              className={`mt-12 max-w-3xl ${isVisible ? "animate-fade-up delay-150" : "opacity-0"}`}
            >
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                {addOns.map((pack, i) => (
                  <div
                    key={pack.name}
                    className="rounded-2xl border border-border bg-card/60 p-5 text-sm"
                  >
          ...
          >
            Licenses cover 1 year of access, updates, and support. If you decide not to renew,
            you still keep access to your records and can export all of your data at any time.
          </p>
        </div>
      </div>
    </section>
