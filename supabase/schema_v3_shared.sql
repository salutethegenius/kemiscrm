...
INSERT INTO role_permissions (organization_id, role, permission, enabled) VALUES
  ...
  ('00000000-0000-0000-0000-000000000001', 'admin', 'payroll', true),
  ...
  ('00000000-0000-0000-0000-000000000001', 'owner', 'payroll', true),
  ...
  ('00000000-0000-0000-0000-000000000001', 'manager', 'payroll', true),
  ...
  ('00000000-0000-0000-0000-000000000001', 'accountant', 'payroll', true),
